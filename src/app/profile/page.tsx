    ...
    <div className="bg-[#0E0E0E] w-full min-h-screen text-white px-5 pt-5">
      <div className="max-w-md mx-auto ">
        ...
        <div className="space-y-4 pt-6">
          ...
          <button className="w-full flex items-center justify-center transition-colors gap-2 underline text-white text-[12px] " type="button" onClick={()=>{router.push("/deposit-withdrawal/history")}}>
            Back
          </button>
        </div>
      </div>
