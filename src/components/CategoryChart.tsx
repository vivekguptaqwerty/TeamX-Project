        ...
        <div className="px-5 mb-10">
            ...
            <div className="flex justify-between items-end mb-5">
                ...
                <div className="flex items-end gap-4">
                    <p className="text-[21px] font-bold">30<span className="text-[12px]">% chance</span></p>
                    <p className="text-[#FF4E00] text-xs flex items-center gap-2"><img className="h-6 pb-[2px]" src="/images/downarrow.png" alt="" />53%</p>
                </div>
            </div>
